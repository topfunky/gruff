...
class TestGruffNet < GruffTestCase
  ...
  def test_similar_high_end_values
    data = %w[29.43 29.459 29.498 29.53 29.548 29.589 29.619 29.66 29.689 29.849 29.878 29.74 29.769 29.79 29.808 29.828]

    g = Gruff::Net.new
    g.title = 'Similar High End Values Test'
    g.data('similar points', data.map(&:to_f))
  ...
  def test_empty_data
    ...
    g.data :Jimmy, [25, nil, 86, 39, 25, 31, 79, 88], '#113285'
    ...
    g.write('test/output/net_empty_data.png')

    assert_same_image('test/expected/net_empty_data.png', 'test/output/net_empty_data.png')
  end
  ...
  def test_duck_typing
    ...
    g.write('test/output/net_duck_typing.png')

    assert_same_image('test/expected/net_duck_typing.png', 'test/output/net_duck_typing.png')
  end
